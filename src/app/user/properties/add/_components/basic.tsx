...
const Basic = (props: Props) => {
  ...
  return (
    <div className={clsx("p-4 gap-3 flex justify-center flex-col space-y-10 bg-neutral-800 border border-green-100 ", props.className)}>
      {/* Type Input */}
      <div className="relative mb-5 border-b border-green-200  ">
        <span className="text-green-300 flex items-center pl-2 mr-2">
          ...
          Property Type</span>
        {/* */}
        <div className="flex mt-5  rounded-xl mb-5 text-black">
          {props.statuses?.map((item) => {
            ...
            return (
              <label
                key={item.id}
                className={`flex flex-col items-center  justify-center ml-2 w-20 h-12  rounded-3xl  border transition duration-300 cursor-pointer ${isSelected
      ...
      <div className="relative mb-5 w-full  max-sm:w-full border-b border-green-400">
        ...
        {/* */}
        <div className="flex flex-wrap  gap-2  w-full   mt-5 max-md:m-1 mb-2 text-black">
          {props.types?.map((item) => {
            ...
            return (
              <label
                key={item.id}
                className={`flex border flex-col items-center rounded-3xl justify-center w-36 max-sm:h-12   h-12  transition duration-300 cursor-pointer ${isSelected
                  ? "bg-green-100 border-green-400 text-green-600"
                  : "bg-white border-slate-200 hover:bg-slate-50"
                  }`}
              >
                ...
                {/* SVG Icons */}
                {item.value === "Home" && (
                  <span className="flex  items-center justify-center  text-sm w-20 h-12">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                      viewBox="0 0 24 24"
                ...
                {item.value === "Commercial" && (
                  <span className="flex items-center justify-center  text-sm mx-4">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                ...
                {item.value === "CO-Work Space" && (
                  <span className="flex items-center justify-center text-nowrap   text-sm">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
