    ...
    <section className="text-gray-300 mb-40 body-font overflow-hidden bg-black max-w-[1080px] mx-auto">
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-50">
          ...
          />
          <div className="fixed top-0 left-1/2 -translate-x-1/2 w-full max-w-md bg-white rounded-2xl shadow-2xl p-6 relative max-h-[90vh] overflow-y-auto">
            <div className="bg-white rounded-2xl shadow-2xl p-6 max-w-md w-full mx-4 relative pointer-events-auto mt">
              <button
                onClick={() => setIsModalOpen(false)}
