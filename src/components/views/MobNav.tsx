       ...
       <Sheet open={isMenuOpen} onOpenChange={setIsMenuOpen}>
          ...
          <SheetContent side="left">
            ...
            <div className="flex flex-col space-y-4 mt-4">
              ...
              <Link href="/properties/buy" className="text-lg font-semibold" onClick={closeMenu}>
                BUY
              </Link>
              <Link href="/properties/rent" className="text-lg font-semibold" onClick={closeMenu}>
                RENT
              </Link>
              <Link href="/user/properties" className="text-lg font-semibold" onClick={closeMenu}>
                SELL
              </Link>
